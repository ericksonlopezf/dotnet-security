...
public sealed class Argon2idPasswordHasher : IPasswordHasher
{
    ...
    public string HashPassword(ReadOnlySpan<char> password)
    {
        ...
        try
        {
            ...
            {
                // Stryker disable once Statement : Wiping ephemeral buffer in finally block
    ...
    private PasswordVerificationResult VerifyPasswordCore(ReadOnlySpan<char> password, string hashedPassword)
    {
        ...
        foreach (var pair in paramPairs)
        {
            ...
            // Stryker disable once String : Parameter key prefix
        ...
        // Stryker disable once Equality,Logical : Cost parameter boundary validations
        ...
        // Stryker disable once Equality,Logical : Pre-allocation stackalloc defense-in-depth bounds
