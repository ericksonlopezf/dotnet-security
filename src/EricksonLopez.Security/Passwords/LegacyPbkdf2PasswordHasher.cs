...
public sealed class LegacyPbkdf2PasswordHasher : IPasswordHasher
{
    ...
    public PasswordVerificationResult VerifyPassword(ReadOnlySpan<char> password, string hashedPassword)
    {
        ...
        string resultTag = result switch
        {
            ...
            // Stryker disable once String : Telemetry result tag
    ...
    private PasswordVerificationResult VerifyPasswordCore(ReadOnlySpan<char> password, string hashedPassword)
    {
        ...
        // Stryker disable once Block : Format check
        ...
        // Stryker disable once Unary : Negative initialization sentinel
        ...
        foreach (var pair in paramPairs)
        {
            ...
            {
                // Stryker disable once Equality,Logical,Block : Time cost parameter bounds
        ...
        // Stryker disable once Equality,Logical,Block : Enforce time cost within allowed bounds
        if (storedIterations < MinAllowedTimeCost || storedIterations > MaxAllowedTimeCost)
        {
            return PasswordVerificationResult.Failed;
        }

        // Stryker disable once Equality,Logical,Block : Pre-allocation stackalloc defense-in-depth bounds
        ...
        // Stryker disable once Equality,Logical,Block : Decoded salt length defense bounds
        ...
        // Stryker disable once Equality,Logical,Block : Decoded hash length defense bounds
