...
public sealed class KeyLifecycleManager : IKeyLifecycleManager, IDisposable
{
    ...
    internal bool FailOnAuditFailure => _failOnAuditFailure;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            // Stryker disable once Statement : Semaphore release in finally
            semaphore.Release();
        }
    }
        ...
        try
        {
            ...
            foreach (var activeKey in activeKeys)
            {
                ...
                if (updateStatusResult.IsFailure)
                {
                    ...
                    // Stryker disable once Statement : Resource disposal on rollback
                    newKey.Dispose();
            ...
            {
                // Stryker disable once String : Diagnostic activity name
    ...
    public void Dispose()
    {
        // Stryker disable once Block : Disposal of cached semaphores
        ...
        // Stryker disable once Statement : Finalizer suppression for sealed IDisposable
