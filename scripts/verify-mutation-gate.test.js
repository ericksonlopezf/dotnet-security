...
console.log('Running tests for verify-mutation-gate.js in EricksonLopez.Security...\n');
...
(async () => {
  ...
  {
    const mockContext = {
      repo: { owner: 'ericksonlopezf', repo: 'dotnet-security' },
      sha: 'abc1234567890'
    };
              ...
              return {
                data: {
                  statuses: [{
                    ...
                    target_url: 'https://github.com/ericksonlopezf/dotnet-security/actions/runs/1'
                  }]
                }
              };
            }
      ...
      rest: {
        repos: {
          ...
          compareCommits: async () => ({
            data: {
              files: [
                { filename: 'src/EricksonLopez.Security/Core.cs' },
                { filename: 'README.md' }
              ]
            }
          })
