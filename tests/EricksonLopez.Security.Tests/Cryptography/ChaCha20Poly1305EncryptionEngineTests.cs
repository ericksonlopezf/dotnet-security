...
public sealed class ChaCha20Poly1305EncryptionEngineTests
{
    ...
    public void ChaCha20Poly1305_TamperedCiphertext_FailsAuthentication()
    {
        ...
        byte[] decrypted = new byte[plaintext.Length];
        Array.Fill(decrypted, (byte)0xFF);
        var decryptResult = engine.Decrypt(
    ...
    public void ChaCha20Poly1305_WhenPlatformNotSupported_ReturnsUnsupportedAlgorithmError()
    {
        try
        {
            ...
            Assert.Equal("The cryptographic algorithm 'ChaCha20Poly1305' is not supported.", enc1.Error.Description);
            ...
            Assert.Equal("The cryptographic algorithm 'ChaCha20Poly1305' is not supported.", enc2.Error.Description);
            ...
            Assert.Equal("The cryptographic algorithm 'ChaCha20Poly1305' is not supported.", dec.Error.Description);
        }
        finally
        {
